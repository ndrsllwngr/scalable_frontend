    ...
    def render(p: Props): VdomTagOf[Div] = {
      ...
      <.div(^.cls := "form-group",
        ...
        <.div(^.cls := "column", ^.id := "player-view",
          ...
          <.div(
          PlaylistBox(PlaylistBox.Props("bla",Some(List(Song(864,"streamingService!","Fineshrine","Purity Ring","Shrines","https://i.scdn.co/image/0beb85a35a4ef3242432207f1a323151db693bce",5,1,false),
